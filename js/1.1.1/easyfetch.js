class EasyFetch {
    constructor() {
      ...
      this.urlBase = "https://corefmvp2.smarttech.pe/fm/api/testproyect";
      this.strings = {
          ...
          if (typeof obj[key] === 'object') {
            ...
            for (let y = 0; y < this.inputs.length; y++) {
              if (obj[key] === this.inputs[y].id) {
                ...
                break; // Finaliza el bucle for cuando se encuentra una coincidencia
              }
            }
          }
        }
    ...
    setCookie(name,value,path="/",lifetime="1"){
      const date = new Date();
